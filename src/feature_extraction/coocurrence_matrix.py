...
def create_coocurrence_matrix_features(images: list[tuple], features_to_extract: list, to_grayscale: Callable, distance, angle, levels=256):
    ...
    grayscale_images = [(id, image, label) for (id, _, label), image in zip(images, grayscale_images)]
